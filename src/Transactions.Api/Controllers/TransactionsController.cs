...
public class TransactionsController : ControllerBase {
  ...
  public async Task<ActionResult<TransactionDto>> GetById(Guid id,
    ...
    return Ok(new TransactionDto(t.Id, t.AccountNumber, t.Amount, t.Currency, t.Type, t.Description,
                                 t.CreatedAt));
  }
  ...
  public async Task<ActionResult<TransactionDto>> Create(CreateTransactionDto dto,
    ...
    var entity = new BankTransaction {
      AccountNumber = dto.AccountNumber, Amount = dto.Amount,
      Currency = dto.Currency,           Type = dto.Type,
      Description = dto.Description,     CreatedAt = DateTimeOffset.UtcNow
    };
    ...
    var result = new TransactionDto(entity.Id, entity.AccountNumber, entity.Amount, entity.Currency,
